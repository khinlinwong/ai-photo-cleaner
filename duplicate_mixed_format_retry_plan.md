...
- **CORE-DUPLICATE-13-PLANNING 进展更新**：已在项目根目录下新建了 [duplicate_mixed_format_200_300_plan.md](file:///C:/Users/khinl/Documents/AI%20Photo%20Cleaner/duplicate_mixed_format_200_300_plan.md) 用于规划 200 张与 300 张混合压缩格式的 true 分支压力测试。100 张 retry 测试的通过不代表 200 / 300 张的规模也能通过，必须按照新规划继续开展分档验证。
- **CORE-DUPLICATE-13 实测结论**：200 张与 300 张混合格式真实图片测试已顺利通过。200张分析耗时 17.65 秒，300张分析耗时 26.04 秒。新旧算法指标完全对齐。但在 300 张 results 大卡片渲染时出现了轻微滚动掉帧，表明浏览器主线程已经接近处理上限。下一步极不建议继续开展 500+ 大批量盲测，必须进入性能优化规划阶段。
