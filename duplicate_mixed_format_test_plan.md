...
- **CORE-PERFORMANCE-1-PLANNING 进展更新**：混合格式 100 / 200 / 300 张三档真实文件压测已全部执行并收集完成。测试边界已从盲目加量推进，正式变更为聚焦主线程计算解耦与 UI 卡片重绘性能优化。详细规划见根目录下新建的 [performance_optimization_plan.md](file:///C:/Users/khinl/Documents/AI%20Photo%20Cleaner/performance_optimization_plan.md)。
